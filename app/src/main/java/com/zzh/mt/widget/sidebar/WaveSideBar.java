package com.zzh.mt.widget.sidebar;
...
public class WaveSideBar extends View {
            ...
            //默认数据
            public  static String[] DEFAULT_INDEX_ITEMS = {"A"};

            private String[] mIndexItems;
            //刷新默认数据
            public void addData(LinkedList<String> list){
                mIndexItems = list.toArray(new String[list.size()]);
                invalidate();
            }
            /**
