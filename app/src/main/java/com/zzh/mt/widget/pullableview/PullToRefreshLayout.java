package com.zzh.mt.widget.pullableview;
...
public abstract class PullToRefreshLayout extends RelativeLayout
{
	...
	private void initView()
	{
		...
		loadmoreView = getLoadView();

		addView(refreshView, new ViewGroup.LayoutParams(-1, -2));
		addView(loadmoreView, new ViewGroup.LayoutParams(-1, -2));
	}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		setMeasuredDimension(mContext.getResources().getDisplayMetrics().widthPixels, getChildAt(0).getMeasuredHeight() + getChildAt(1).getMeasuredHeight() +getChildAt(2).getMeasuredHeight());
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b)
	{
		if (!isLayout)
		{
			...
			System.out.println(refreshView.getMeasuredWidth()+"width..........");
